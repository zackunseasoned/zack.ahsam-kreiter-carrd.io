...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-down', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });
		onvisible.add('.image.style1', { style: 'zoom-in-image', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 250, replay: false });
		...
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-right', speed: 1250, intensity: 10, threshold: 3, delay: 250, replay: false });
